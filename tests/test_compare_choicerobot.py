...
def test_compare_choicerobot():
    """
    Test to see if the python package TetraSolver is broken. The comparison is made
    with the solver on choicerobot.com itself. Trows AssertionError when the result is
    not the same, indicating the python code is broken.
